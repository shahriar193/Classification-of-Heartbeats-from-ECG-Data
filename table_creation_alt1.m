function [data_table] = table_creation(preRR_1, postRR_1, Qpeaks_1, Rpeaks_1, Speaks_1, QRSinterval_1, QR_peak_distance_1 ,QRS_triangular_area_1,  beat_type_2)
...
QRS_triangular_area_1 = QRS_triangular_area_1'; 
...
%% 
data_table = array2table([postRR_1, preRR_1, Qpeaks_1, Rpeaks_1, Speaks_1, QRSinterval_1, QR_peak_distance_1, QRS_triangular_area_1,  beat_type_2], "VariableNames", {'postRR_1', 'preRR_1', 'Qpeaks_1', 'Rpeaks_1', 'Speaks_1', 'QRSinterval_1', 'QR_peak_distance_1','QRS_triangular_area_1', 'beat_type_2'});
...
data_table.QRS_triangular_area_1 = double(data_table.QRS_triangular_area_1);
